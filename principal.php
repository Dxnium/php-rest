     ...
     <div id="myCarousel" class="carousel slide" data-ride="carousel">
        <div class="carousel-inner">
            <div class="carousel-item active  text-center">
                <img src="img/lechona.png" alt="Platillo" class="card-img-top w-50 mx-auto">
            </div>
            <div class="carousel-item  text-center">
                <img src="img/aguapanela.png" alt="Platillo" class="card-img-top w-50 mx-auto">
            </div>
            <!-- Agrega más elementos carousel-item según sea necesario -->
            <div class="carousel-item  text-center">
                <img src="img/arepa.png" alt="Platillo" class="card-img-top w-50  mx-auto">
            </div>

            <div class="carousel-item  text-center">
                <img src="img/sancocho.png" alt="Platillo" class="card-img-top w-50  mx-auto">
            </div>
