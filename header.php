...
<head>
    ...
    <!-- Agrega este enlace a tu archivo header.php -->
...
<body>
    ...
    <nav class="navbar navbar-expand-lg bg-amarillo">
        <div class="container">
            ...
            <a class="navbar-brand" href="/php-rest">
            ...
            <div class="collapse navbar-collapse" data-bs-target="navbarSupportedContent">
                ...
                <li class="nav-item mx-0 mx-lg-1"><a class="nav-link py-3 px-0 px-lg-3 rounded" href="principal.php">Principal</a></li>
                    <li class="nav-item mx-0 mx-lg-1"><a class="nav-link py-3 px-0 px-lg-3 rounded" href="menu.php">Menú</a></li>
